...
export const env = createEnv({
	...
	shared: {
		...
		NEXT_PUBLIC_LIVEKIT_HOST: z.string(),
	},
	...
	runtimeEnv: {
		...
		GOOGLE_OAUTH_CLIENT_RESPONSE_TYPE:
			process.env.GOOGLE_OAUTH_CLIENT_RESPONSE_TYPE,
		...
		NEXT_PUBLIC_LIVEKIT_HOST: process.env.NEXT_PUBLIC_LIVEKIT_HOST,
